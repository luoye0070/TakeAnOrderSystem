...
<body role="document">
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#">餐萌点菜系统-工作人员端</a>
    </div>
    <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav">
            <g:if test="${controllerName=="staff" && actionName=="orderList"}">
                <li class="active"><g:link controller="staff" action="orderList">订单列表</g:link></li>
            </g:if>
            <g:else>
            ...
            <g:if test="${controllerName=="staff" && actionName in ["orderInput"]}">
                <li class="active"><g:link controller="staff" action="orderInput">订单创建</g:link></li>
            </g:if>
            <g:else>
            ...
            <g:if test="${controllerName=="staff" && actionName=="dishList"}">
                <li class="active"><g:link controller="staff" action="dishList">点菜列表</g:link></li>
            </g:if>
            <g:else>
            ...
            <g:if test="${controllerName=="reserveStaff" && actionName in ["reserveOrderList","reserveOrderDetail"]}">
                <li class="active"><g:link controller="reserveStaff" action="reserveOrderList">桌位预定列表</g:link></li>
            </g:if>
            <g:else>
            ...
            <g:if test="${controllerName=="reserveStaff" && actionName in ["reserveDinnerTimeInput","reserveTables","createReserveOrder","dishOfReserveOrder"]}">
                <li class="active"><g:link controller="reserveStaff" action="reserveDinnerTimeInput">桌位预定</g:link></li>
            </g:if>
            <g:else>
