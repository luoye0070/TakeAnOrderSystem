...
<div class="mc_main">
    <div class="mcm_top">
        <div class="mcm_top_name">订单${orderInfo?.orderNum}-信息</div>
    ...
    <!--完成点菜-->
    <div class="span11">
        <form class="form-horizontal" method="POST" id="back_to_dish_form" action="dd">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="submit"
                           value="${message(code: 'default.button.addDish.label', default: 'Add Dish')}"
                           class="btn send_btn"/>
                </div>
            </div>
        </form>
